...
![Форма перекроссировки бренда поставщика](<../.gitbook/assets/image (2).png>)
...
![Форма элемента справочника "Бренды"](<../.gitbook/assets/image (56).png>)
...
### Шапка <a href="shapka" id="shapka"></a>
...
#### Групповые операции <a href="gruppovye-operacii" id="gruppovye-operacii"></a>
...
![Бренды до обработки](<../.gitbook/assets/image (49).png>)
...
![Результат обновления перекроссировок](<../.gitbook/assets/image (10).png>)
...
![Результат привязки к основному бренду](<../.gitbook/assets/image (63).png>)
